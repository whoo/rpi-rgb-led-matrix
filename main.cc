...
int main(int argc, char *argv[]) {
	...
	while (1)
	{
		...
		image_gen = new RotoZoom2(&m,"pixmap/champ.ppm"); image_gen->Start(); sleep(30); delete image_gen;
		...
		image_gen = new RotoZoom(&m,"pixmap/question.ppm"); image_gen->Start(); sleep(30); delete image_gen;
		image_gen = new Clock(&m); image_gen->Start(); sleep(60); delete image_gen;

		delete data;  data = new  GetData('n'); data->Start();
		image_gen = new RotoZoom(&m,"pixmap/star.ppm"); image_gen->Start(); sleep(30); delete image_gen;
